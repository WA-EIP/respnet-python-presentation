...
::::{.columns}
:::{.column width="50%"}
:::{.codewindow .terminal .codewindow-dark}
```bash
...
:::{.column width="50%"}
:::{.codewindow .terminal bg="#fdf6e3" header-bg="#eee8d5" shadow-color="#93a1a1"}
```bash
uv run main.py
```
:::
...
- [polars](https://docs.pola.rs/user-guide/getting-started/) for working with dataframes (it's like dplyr with data.table speed + lazy + streaming)
...
![](images/src.png){fig-align="center"}
