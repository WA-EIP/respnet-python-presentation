...
:::{.column width="50%"}
:::{.codewindow .terminal bg="#fff7fa" header-bg="#efd6e3" shadow-color="#b76e8a"}
```bash
uv run main.py
```
:::
...
```bash
uv add polars pyodbc redcap
```
:::

:::{.codewindow .terminal name="03-run-code" bg="#fff7fa" header-bg="#efd6e3" shadow-color="#b76e8a"}
```bash
uv run main.py
```
::: 
